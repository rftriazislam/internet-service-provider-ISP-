                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a style="color:green"
                                            href="{{url('pakagePublish')}}/{{$view_pakage->id}}">Active</a>
                                        @else
                                        <a style="color:red"
                                            href="{{url('pakageUnpublish')}}/{{$view_pakage->id}}">Inactive</a>
                                        @endif
                                    </td>
                                    <td>
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            <button type="button" style="color:white  ;background-color:red"
                                                class="btn "><a style="color:white"
                                                    href="{{url('pakageDelete')}}/{{$view_pakage->id}}">
                                                    Delete</a></button>
                                            <button type="button" style=" color:white ;background-color:aqua"
                                                class="btn "><a style="color:white"
                                                    href="{{url('pakageEdit')}}/{{$view_pakage->id}}"> Updated/Edit</a></button>
