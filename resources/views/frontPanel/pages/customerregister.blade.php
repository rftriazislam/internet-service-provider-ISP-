                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-1 text-center">
                        <div class="header-inner-content"
                            style="border-radius: 14px;border: .5px solid red;background-color:#F79101">
                            <form action="{{ route('register') }}" method="post" enctype="multipart/form-data"
                                style="color:black;" class="form-horizontal">
                                @csrf
                                ...
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="email-input"
                                            class=" form-control-label">E-mail</label></div>
                                    <div class="col-9 col-md-6">
                                ...
                                <div class="row form-group">
                                    <button type="submit" class=" btn "
                                        style="margin-bottom: 7px;margin-right: -210px;width:100px;background-color: #a2999b;">Login</button>
                                </div>
                            </form>
