                        ...
                        <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{$loop->index+1}}</td>
                                    <td>{{$view_user->id}}</td>
                                    <td> <a href="{{url('userprofilepower')}}/{{$view_user->id}}" style="color:blue"> {{$view_user->customer_name}}</a> </td>
                                    <td>{{$view_user->user_name}}</td>
                                    ...
                                    <td>
                                        ...
                                        <button style="color:white ;background-color:green "><a style="color:white"
                                                href="{{url('userPublishpower')}}/{{$view_user->id}}">ON</a></button>
                                        @else
                                        <button style=" color:white ;background-color:red"><a style="color:white"
                                                href="{{url('userUnpublishpower')}}/{{$view_user->id}}">OFF</a></button>
                                        @endif
                                    </td>
                                    <td>
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            <button type="button" style="color:white  ;background-color:red"
                                                class="btn "><a style="color:white"
                                                    href="{{url('userDeletepower')}}/{{$view_user->id}}">
                                                    Delete</a></button>

                                            <button type="button" style=" color:white ;background-color:aqua"
                                                class="btn "><a style="color:white"
                                                    href="{{url('userEditpower')}}/{{$view_user->id}}">
                                                    Edit</a></button>
