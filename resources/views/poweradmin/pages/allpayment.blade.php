                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Payment Issue</strong>
                            </div>
                            @if(session('message'))
                                ...
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    @forelse($allpayment as $view_payment)
                                        ...
                                        <button style="color:white ;background-color:green "><a style="color:white"
                                                href="{{url('paymentPublishpower')}}/{{$view_payment->id}}">Active</a></button>
                                        @else
                                        <button style=" color:white ;background-color:red"><a style="color:white"
                                                href="{{url('paymentUnpublishpower')}}/{{$view_payment->id}}">Inactive</a></button>
                                        @endif
                                    </td>
                                            <td><div class="btn-group" role="group" aria-label="Basic example">
                                            <button type="button" style="color:white  ;background-color:red" class="btn "><a style="color:white" href="{{url('paymentDeletepower')}}/{{$view_payment->id}}"> Delete</a></button> 
                                            
                                            <button type="button" style=" color:white ;background-color:aqua" class="btn "><a  style="color:white"  href="{{url('paymentEditpower')}}/{{$view_payment->id}}"> Edit</a></button>
